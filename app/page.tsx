...
type BillingInfo = { plan: "trial" | PaidPlan; billingCycle: "monthly" | "annual"; subscriptionStatus: "trial" | "pending" | "authorized" | "paused" | "cancelled"; trialEndsAt?: string | null; currentPeriodEnd?: string | null };
  ...
  async function startSubscription(plan: PaidPlan) {
    ...
    try {
      ...
      if (data.upgraded) {
        ...
        setBilling((current) => ({ ...current, plan: upgradedPlan, billingCycle: data.billingCycle || current.billingCycle, subscriptionStatus: "authorized" }));
