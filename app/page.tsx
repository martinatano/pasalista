  ...
  if (screen === "landing") {
    return (
      <main className="landing-page">
        ...
        <footer><div><button className="landing-brand" aria-label="Ir al inicio" onClick={goToHome}><LogoMark /> PasáLista</button><p>Tu Excel, listo para tomar pedidos.</p></div><nav className="legal-links" aria-label="Información legal"><a href={`mailto:${process.env.NEXT_PUBLIC_SUPPORT_EMAIL}?subject=${encodeURIComponent("Consulta desde PasáLista")}`}>Contacto</a><a href="/terminos">Términos</a><a href="/privacidad">Privacidad</a><a href="/cancelacion">Cancelación</a><a href="/baja">BOTÓN DE BAJA DE SERVICIO</a><a href="/arrepentimiento">BOTÓN DE ARREPENTIMIENTO</a></nav></footer>
      </main>
    );
  }
      ...
      {view === "business" ? (
        <section className="business-layout">
          ...
          <aside className={mobileNavOpen ? "nav-open" : ""}>
            ...
            <a className="sidebar-support" href={`mailto:${process.env.NEXT_PUBLIC_SUPPORT_EMAIL}?subject=${encodeURIComponent("Consulta o reporte de falla — PasáLista")}`}>¿Consulta o encontraste un error? Escribinos</a>
          </aside>
